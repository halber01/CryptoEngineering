...
from Example_code.Example_DH_KDF_AES_AEAD import generate_ecdh_key_pair, generate_binary_string
    ...
    while True:
        if not awaiting_response:
            try:
                ...
                print(f"{my_identity}: Receive the public key message from Alice: \"{decoded_data}\" ")
...
def initiate_key_exchange(conn, my_identity, peer_identity):
    ...
    bob_public_key_printable = bob_pk.public_bytes(
